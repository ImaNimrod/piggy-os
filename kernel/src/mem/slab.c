...
static struct cache* kmalloc_caches[10] = {0};
...
void slab_init(void) {
    ...
    kmalloc_caches[0] = slab_cache_create("kmalloc_16", 16);
    kmalloc_caches[1] = slab_cache_create("kmalloc_24", 24);
    kmalloc_caches[2] = slab_cache_create("kmalloc_32", 32);
    kmalloc_caches[3] = slab_cache_create("kmalloc_48", 48);
    kmalloc_caches[4] = slab_cache_create("kmalloc_64", 64);
    kmalloc_caches[5] = slab_cache_create("kmalloc_92", 92);
    kmalloc_caches[6] = slab_cache_create("kmalloc_128", 128);
    kmalloc_caches[7] = slab_cache_create("kmalloc_256", 256);
    kmalloc_caches[8] = slab_cache_create("kmalloc_512", 512);
    kmalloc_caches[9] = slab_cache_create("kmalloc_512", 1024);
}
